...
$nomdb = filter_input(INPUT_POST, 'nom', FILTER_SANITIZE_STRING);
$prenomdb = filter_input(INPUT_POST, 'prenom', FILTER_SANITIZE_STRING);
$matriculedb = filter_input(INPUT_POST, 'matricule', FILTER_SANITIZE_STRING);
$dateNaissancedb = filter_input(INPUT_POST, 'dateNaissance', FILTER_SANITIZE_STRING);
$lieuNaissancedb = filter_input(INPUT_POST, 'lieuNaissance', FILTER_SANITIZE_STRING);
$paysNaissancedb = filter_input(INPUT_POST, 'paysNaissance', FILTER_SANITIZE_STRING);
$nationalitedb = filter_input(INPUT_POST, 'nationalite', FILTER_SANITIZE_STRING);
$sexedb = filter_input(INPUT_POST, 'sexe', FILTER_SANITIZE_STRING);
$adressedb = filter_input(INPUT_POST, 'adresse', FILTER_SANITIZE_STRING);
$codePostaldb = filter_input(INPUT_POST, 'codePostal', FILTER_SANITIZE_STRING);
$localitedb = filter_input(INPUT_POST, 'localite', FILTER_SANITIZE_STRING);
$telephonedb = filter_input(INPUT_POST, 'telephone', FILTER_SANITIZE_STRING);
$maildb = filter_input(INPUT_POST, 'mail', FILTER_SANITIZE_STRING);
$coursdb = filter_input(INPUT_POST, 'cours', FILTER_SANITIZE_STRING);
...
$db = @mysqli_connect("localhost", "c0_coursdusoir", "tinchen82") or die("Verbindung zu MySQL gescheitert");
        ...
        $sql="INSERT INTO inscriptionscds " . 
        "(nom, prenom, matricule, datedenaissance, lieudenaissance, paysdenaissance, nationalite, sex, adresse, codepostal, localite, telephone, email, cours ) " . 
        "VALUES ('$nomdb', '$prenomdb', '$matriculedb', '$dateNaissancedb', '$lieuNaissancedb', '$paysNaissancedb', '$nationalitedb', '$sexedb', '$adressedb', '$codePostaldb', '$localitedb', '$telephonedb', '$maildb', '$coursdb')";
