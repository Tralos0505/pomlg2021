    ...
    <div class="contentContainer blueBackground">
        ...
        <div id="topContainer" class="contentCentered">
            ...
            <div class="grid-2-col50g">
                <a href="../coursDuSoir/InscriptionIndex.php" target=""><button class="bigButtonGreen">Retour</button></a>
                <a href="../coursDuSoir/InscriptionIndex.php" target=""><button class="bigButtonGreen">Zereck</button></a>
