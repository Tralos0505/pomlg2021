...
<!--TITRE END -->
        ...
        <div class="greenBackground2 contentCentered formulaire">
                    ...
                    <form action="../phpElements/mailCoursDuSoirDB.php" method="post" id="contactFormMLG"> 
                        ...
                        <div class="grid-2-col50">
                            ...
                            <div class="inscription">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="text" name="matricule" size="40" minlength="1" maxlength="30" class="inputField2" value="" required />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <!-- <input type="text" name="dateNaissance" size="40" class="inputField2" value="" required /> -->
                                    <input type="date" name="dateNaissance" class="inputField2" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" required>
                                    </td>
                            ...
                            <div class="inscription">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input type="text" name="codePostal" size="40" maxlength="7" class="inputField2" value="" required />       
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input type="text" name="telephone" size="40" maxlength="50" class="inputField2" value="" required />     
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input type="mail" name="mail" size="40" maxlength="80" class="inputField2" value="" required />  
                                        </td>
                                ...
                                <div class="kiste">
                                    ...
                                    <option value="SO-MED-3">SO-MED-3</option>
